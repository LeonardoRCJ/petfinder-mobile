    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Leonardo</Text>
        </View>
          ...
          <View style={styles.menuContainer}>
            ...
            <ScrollView style={styles.menuItems}>
              <TouchableOpacity
                ...
                onPress={() => {
                  navigation.navigate('admin_viewUsers');
                  setShowMenu(false);
                }}>
              ...
              <TouchableOpacity
                style={styles.menuItem}
                onPress={() => {
                  navigation.navigate('admin_viewPets');
                  setShowMenu(false);
                }}>
              ...
              <TouchableOpacity
                style={styles.menuItem}
                onPress={() => {
                  navigation.navigate('AdoptionsRequests');
                  setShowMenu(false);
                }}>
                <Ionicons name="people" size={20} color="#FF6B00" />
                <Text style={styles.menuItemText}>Adoções</Text>
              </TouchableOpacity>
